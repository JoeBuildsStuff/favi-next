...
function readInitialConfig() {
  if (typeof window === "undefined") {
    return parseFaviconConfigSearch(new URLSearchParams())
  }
  return parseFaviconConfigSearch(new URLSearchParams(window.location.search))
}

export function FaviconSelectionProvider({ children }: { children: ReactNode }) {
  const initialConfig = useMemo(() => readInitialConfig(), [])
